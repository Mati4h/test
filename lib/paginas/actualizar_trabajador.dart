...
class Actualizar_Trabajador extends StatefulWidget {
  @override
  State<Actualizar_Trabajador> createState() => _ActualizarTrabajadorState();
}

class _ActualizarTrabajadorState extends State<Actualizar_Trabajador> {
